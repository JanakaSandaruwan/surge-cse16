...
<?php
  ...
  $query="SELECT * FROM acalist";
 

  $m1=mysqli_query($connection, $query);
  ...
  if($m1 ){
    while($u1=mysqli_fetch_assoc($m1) ){
        ...
        $studentmark .="<li>";
        $studentmark .="<a href=\"std_progress.php?id={$u1['id']}\">{$u1['id']}</a>";
        $studentmark .="</li>";
          ...
          <div id="main-wrapper" class="col-md-11 pull-right">
              <div id="main" style="padding-left: 50px;">
                <div class="page-header">
                  <h3 style="font-weight: bold; font-family:'Courier New'; padding-top: 10px">Academic Feable Student List</h3>
                </div>
                <div>
                   <?php echo "$studentmark"?>
                </div>
                <div class="item1" style="top: 2150px; left:223px; width:1367px; height:150px;background-image: url(img/footer.jpg);" >

                  <p style="padding-left:1140px;padding-top: 75px;font-family:'Courier New'; font-weight: bold;">
                    <img src="img/surge.png" style="width: 30px;height: 30px"> By TEAM SURGE
                  </p>
                </div>
